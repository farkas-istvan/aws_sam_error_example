...
/**
 * Precompiled org.example.java-application-conventions script plugin.
 **/
public class OrgExampleJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_OrgExampleJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("org.example.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgExampleJavaApplicationConventions").asSubclass(BasicScript.class);
